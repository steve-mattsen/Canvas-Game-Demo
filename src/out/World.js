...
var player = new Obj_1.Obj('player', (0, Geo_1.vec)((Vars_1["default"].canvasWidth - ss.rowSize - 1) / (2 * Vars_1["default"].cameraScale), (Vars_1["default"].canvasHeight - ss.colSize) / (2 * Vars_1["default"].cameraScale)), anims.idle_down.sprites[0], new Geo_1.Box(0, 0, 10, 10, ['center', 'bottom']), anims);
Obj_1.Obj.addObj(player);
var tree_sprite = (0, Sprites_1.sprt)('tree');
var tree = new Obj_1.Obj('tree', (0, Geo_1.vec)(50, 100), tree_sprite, new Geo_1.Box(tree_sprite.drawBox.width * .4, tree_sprite.drawBox.height * .75, tree_sprite.drawBox.width * .2, tree_sprite.drawBox.height * .2, ['center', 'bottom']));
