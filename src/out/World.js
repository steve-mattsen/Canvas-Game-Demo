...
spritesheet_link.size = new Vec2_1.vec2(1024, 887);
...
var xSize = 102.4;
var ySize = 111.25;
var player = new Obj_1.Obj('player', Sprites_1.Img.store['spritesheet_link'], new Vec2_1.vec2(xSize - 1, ySize), new Vec2_1.vec2((window.innerWidth - xSize - 1) / 2, (window.innerHeight - ySize) / 2), anims);
