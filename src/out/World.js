...
var player = new Obj_1.Obj('player', ss.drawBox.bottomRight, (0, Geo_1.vec)((Vars_1["default"].canvasWidth - ss.rowSize - 1) / 2, (Vars_1["default"].canvasHeight - ss.colSize) / 2), new Sprites_1.Sprite(Sprites_1.Img.store.spritesheet_link, new Geo_1.box((0, Geo_1.vec)(0, 0), (0, Geo_1.vec)(ss.colSize, ss.rowSize))), anims);
player.animState = 'idle_down';
Obj_1.Obj.addObj(player);
var tree = new Obj_1.Obj('tree', null, (0, Geo_1.vec)(50, 50), 'tree');
