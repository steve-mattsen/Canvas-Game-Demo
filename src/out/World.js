...
var xSize = 102.4;
var ySize = 111.25;
var player = new Obj_1.Obj('player', Sprites_1.Img.store['spritesheet_link'], (0, Vec2_1.vec)(xSize - 1, ySize), (0, Vec2_1.vec)((window.innerWidth - xSize - 1) / 2, (window.innerHeight - ySize) / 2), anims);
